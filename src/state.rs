...
pub struct AppState {
    ...
    pub auth_register_rate_limits: Arc<FixedWindowRateLimiter>,
    pub auth_login_rate_limits: Arc<FixedWindowRateLimiter>,
    pub message_create_rate_limits: Arc<FixedWindowRateLimiter>,
    pub attachment_presign_rate_limits: Arc<FixedWindowRateLimiter>,
    pub attachment_upload_rate_limits: Arc<FixedWindowRateLimiter>,
...
impl AppState {
    ...
    pub fn with_stores(config: AppConfig, stores: AppStores) -> Self {
        ...
        Self {
            ...
            bots,
            webhooks,
            auth_register_rate_limits: Arc::new(FixedWindowRateLimiter::auth_register()),
            auth_login_rate_limits: Arc::new(FixedWindowRateLimiter::auth_login()),
            message_create_rate_limits: Arc::new(FixedWindowRateLimiter::message_create()),
            attachment_presign_rate_limits: Arc::new(FixedWindowRateLimiter::attachment_presign()),
            attachment_upload_rate_limits: Arc::new(FixedWindowRateLimiter::attachment_upload()),
